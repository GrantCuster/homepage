import { r as requireReact, a as requireReactDom, g as getDefaultExportFromCjs } from "./assets/index-TS6MFGZj.js";
var server_edge$1 = {};
...
function requireServer_edge() {
  if (hasRequiredServer_edge) return server_edge$1;
  ...
  server_edge$1.version = b.version;
  server_edge$1.renderToReadableStream = b.renderToReadableStream;
  server_edge$1.renderToString = l.renderToString;
  server_edge$1.renderToStaticMarkup = l.renderToStaticMarkup;
  if (b.resume) {
    server_edge$1.resume = b.resume;
  }
  return server_edge$1;
}
