import { a as requireReactDom, g as getDefaultExportFromCjs } from "./assets/index-TS6MFGZj.js";
var reactServerDomWebpackClient_edge_production$1 = {};
/**
 * @license React
...
function requireReactServerDomWebpackClient_edge_production() {
  if (hasRequiredReactServerDomWebpackClient_edge_production) return reactServerDomWebpackClient_edge_production$1;
  ...
  var ReactDOM = requireReactDom(), decoderOptions = {
    stream: true
  };
  ...
  (_globalThis = globalThis).__WAKU_CLIENT_MODULE_LOADING__ || (_globalThis.__WAKU_CLIENT_MODULE_LOADING__ = /* @__PURE__ */ new Map());
  (_globalThis1 = globalThis).__WAKU_CLIENT_MODULE_CACHE__ || (_globalThis1.__WAKU_CLIENT_MODULE_CACHE__ = /* @__PURE__ */ new Map());
  (_globalThis2 = globalThis).__WAKU_CLIENT_CHUNK_LOAD__ || (_globalThis2.__WAKU_CLIENT_CHUNK_LOAD__ = function(id) {
    if (!globalThis.__WAKU_CLIENT_MODULE_LOADING__.has(id)) {
      globalThis.__WAKU_CLIENT_MODULE_LOADING__.set(id, globalThis.__WAKU_CLIENT_IMPORT__(id).then(function(m) {
        globalThis.__WAKU_CLIENT_MODULE_CACHE__.set(id, m);
      }));
    }
    return globalThis.__WAKU_CLIENT_MODULE_LOADING__.get(id);
  });
  (_globalThis3 = globalThis).__WAKU_CLIENT_REQUIRE__ || (_globalThis3.__WAKU_CLIENT_REQUIRE__ = function(id) {
    return globalThis.__WAKU_CLIENT_MODULE_CACHE__.get(id);
  });
  function requireAsyncModule(id) {
    var promise = __WAKU_CLIENT_REQUIRE__(id);
  ...
  function preloadModule(metadata) {
    for (var chunks = metadata[1], promises = [], i = 0; i < chunks.length; ) {
      ...
      if (void 0 === entry) {
        entry = __WAKU_CLIENT_CHUNK_LOAD__(chunkId);
        promises.push(entry);
  ...
  function requireModule(metadata) {
    var moduleExports = __WAKU_CLIENT_REQUIRE__(metadata[0]);
    ...
    function resolveToJSON(key, value) {
      ...
      if ("object" === (typeof value === "undefined" ? "undefined" : _type_of(value))) {
          ...
          case REACT_LAZY_TYPE:
            ...
            try {
              ...
              if ("object" === (typeof x === "undefined" ? "undefined" : _type_of(x)) && null !== x && "function" === typeof x.then) {
                ...
                parentReference = function parentReference2() {
                  try {
        ...
        if (key !== ObjectPrototype && (null === key || null !== getPrototypeOf(key))) {
          if (void 0 === temporaryReferences) throw Error("Only plain objects, and a few built-ins, can be passed to Server Actions. Classes or null prototypes are not supported.");
          return "$T";
        }
        return value;
      }
  ...
  function waitForReference(referencedChunk, parentObject, key, response, map, path) {
    function fulfill(value) {
      ...
      if (parentObject[0] === REACT_ELEMENT_TYPE && "object" === _type_of(handler.value) && null !== handler.value && handler.value.$$typeof === REACT_ELEMENT_TYPE) switch (value = handler.value, key) {
        case "3":
          value.props = i;
      }
      handler.deps--;
  ...
  function startAsyncIterable(response, id, iterator) {
    ...
    $jscomp$compprop0 = ($jscomp$compprop0[ASYNC_ITERATOR] = function $jscomp$compprop02() {
      var nextReadIndex = 0;
  ...
  reactServerDomWebpackClient_edge_production$1.createFromFetch = function(promiseForResponse, options) {
  ...
  reactServerDomWebpackClient_edge_production$1.createFromReadableStream = function(stream, options) {
    options = createResponseFromOptions(options);
    startReadingFromStream(options, stream);
    return getChunk(options, 0);
  };
  reactServerDomWebpackClient_edge_production$1.createServerReference = function(id) {
    return createServerReference$1(id, noServerCall);
  };
  reactServerDomWebpackClient_edge_production$1.createTemporaryReferenceSet = function() {
    return /* @__PURE__ */ new Map();
  };
  reactServerDomWebpackClient_edge_production$1.encodeReply = function(value, options) {
  ...
  return reactServerDomWebpackClient_edge_production$1;
}
var reactServerDomWebpackClient_edge_productionExports = requireReactServerDomWebpackClient_edge_production();
const reactServerDomWebpackClient_edge_production = /* @__PURE__ */ getDefaultExportFromCjs(reactServerDomWebpackClient_edge_productionExports);
export {
  reactServerDomWebpackClient_edge_production as default
};
